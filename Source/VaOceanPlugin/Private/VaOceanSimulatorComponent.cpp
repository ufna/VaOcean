...
void UVaOceanSimulatorComponent::UpdateDisplacementMap(float WorldTime)
{
	...
	ENQUEUE_UNIQUE_RENDER_COMMAND_TWOPARAMETER(
		...
		FUpdateSpectrumCSPerFrame, PerFrameParams, UpdateSpectrumCSPerFrameParams,
		{
			...
			TShaderMapRef<FUpdateSpectrumCS> UpdateSpectrumCS(GetGlobalShaderMap(ERHIFeatureLevel::SM5));
	...
	ENQUEUE_UNIQUE_RENDER_COMMAND_THREEPARAMETER(
		...
		FUpdateDisplacementPSPerFrame, PerFrameParams, UpdateDisplacementPSPerFrameParams,
		{
			...
			TShaderMapRef<FQuadVS> QuadVS(GetGlobalShaderMap(ERHIFeatureLevel::SM5));
			TShaderMapRef<FUpdateDisplacementPS> UpdateDisplacementPS(GetGlobalShaderMap(ERHIFeatureLevel::SM5));
	...
	ENQUEUE_UNIQUE_RENDER_COMMAND_FOURPARAMETER(
		...
		FTextureRenderTargetResource*, DisplacementRenderTarget, DisplacementRenderTarget,
		{
			...
			TShaderMapRef<FQuadVS> QuadVS(GetGlobalShaderMap(ERHIFeatureLevel::SM5));
			TShaderMapRef<FGenGradientFoldingPS> GenGradientFoldingPS(GetGlobalShaderMap(ERHIFeatureLevel::SM5));
